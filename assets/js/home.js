...
const searchPage = function () {
  ...
  const playSong = function (songCover, songName, artistName, songPreview, e) {
    ...
    const clickedBtn = e.target.closest(".songButton")
    if (clickedBtn) {
      clickedBtn.classList.add("text-primary")
      clickedBtn.classList.remove("text-light")
    }
                      ...
                      <div class="card border-0 p-3">
                        <div class="card-body h-100">
                          <ul class="list-unstyled mb-0 d-flex justify-content-between flex-column h-100">
                            <button class="border-0 p-0 shadow-none bg-transparent songButton" onclick="playSong(
        ...
        if (index === 0) {
          ...
          <div class="d-none d-md-flex col-9 col-md-7"><h2 class="fw-bold mb-4">Ti potrebbe piacere anche</h2>
                    ...
                    <div class="col-9 col-md-4 bg-dark py-3 ps-3 rounded-2"
                      ...
                      <div class="card border-0 p-3">
                        <div class="card-body">
                              <button class="border-0 shadow-none bg-transparent songButton" onclick="playSong(
                              '${data.data[0].album.cover_medium}',
                              '${data.data[0].title.replaceAll("'", "")}',
                              '${data.data[0].artist.name}',
                              '${data.data[0].preview}',
